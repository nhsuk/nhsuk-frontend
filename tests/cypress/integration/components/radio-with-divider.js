describe('Radio button with divider component tests', function () {
  ...
  it('Navigating to List panel Component', function () {
    cy.visit(Cypress.config().baseUrl + '/radios/divider.html')
  });
  ...
  it('To check if there is a divider', function () {
    cy.get('.nhsuk-radios__divider')
  });
});
