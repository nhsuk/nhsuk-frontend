describe('Pagination Component', function () {
  ...
  it('Checking for pagination prev class', function () {
    cy.get('.nhsuk-pagination').children().should('have.class', 'nhsuk-pagination__link nhsuk-pagination__link--prev')
  });
  ...
  it('Checking for pagination next class', function () {
    cy.get('.nhsuk-pagination').children().should('have.class', 'nhsuk-pagination__link nhsuk-pagination__link--next')
  });
