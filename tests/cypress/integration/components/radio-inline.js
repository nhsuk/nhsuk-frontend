describe('Radio button inline component tests', function () {
  ...
  it('Navigating to List panel Component', function () {
    cy.visit(Cypress.config().baseUrl + '/radios/inline.html')
  });
  ...
  it('To check the radio button are in line', function () {
    cy.get('.nhsuk-radios.nhsuk-radios--inline')
  });
});
