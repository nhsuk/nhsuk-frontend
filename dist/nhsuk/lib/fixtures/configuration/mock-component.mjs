 ...
 */
class MockConfigurableComponentBoolean extends ConfigurableComponent {
  /**
   * @param {Element | null} $root - HTML element to use for component
 ...
 */
class MockConfigurableComponentNumber extends ConfigurableComponent {
  /**
   * @param {Element | null} $root - HTML element to use for component
...
class MockConfigurableComponentNoSchema extends ConfigurableComponent {
  static moduleName = 'mock-component';
  static defaults = {
    example: 0
  };
}
class MockConfigurableComponentNoDefaults extends ConfigurableComponent {
  static moduleName = 'mock-component';
  static schema = {
    properties: {
      example: {
 ...
 */
class MockConfigurableComponentAllOf extends ConfigurableComponent {
  static moduleName = 'mock-component';
 ...
 * @augments {ConfigurableComponent<MockConfigOptional>}
 */
class MockConfigurableComponentAnyOf extends ConfigurableComponent {
  static moduleName = 'mock-component';
 ...
 * @augments {ConfigurableComponent<MockConfigOptional>}
 */
class MockConfigurableComponentMixed extends ConfigurableComponent {
  static moduleName = 'mock-component';
...
export { MockComponent, MockComponentError, MockConfigurableComponent, MockConfigurableComponentAllOf, MockConfigurableComponentAnyOf, MockConfigurableComponentBoolean, MockConfigurableComponentMixed, MockConfigurableComponentNoDefaults, MockConfigurableComponentNoSchema, MockConfigurableComponentNumber };
//# sourceMappingURL=mock-component.mjs.map
