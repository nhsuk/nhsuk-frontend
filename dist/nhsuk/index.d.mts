 ...
 * @returns {InstanceType<ComponentClass>[]} Array of initialised components
 */
export function createAll<ComponentClass extends CompatibleClass | CompatibleClass<typeof ConfigurableComponent>>(Component: ComponentClass, config?: ComponentConfig<ComponentClass> | undefined, $scope?: Element | null | undefined): InstanceType<ComponentClass>[];
