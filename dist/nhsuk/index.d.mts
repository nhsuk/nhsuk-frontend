...
export type Config = {
     ...
     * - Checkboxes config
     */
    checkboxes?: ComponentConfig<typeof Checkboxes>;
    /**
     * - Code config
     */
    code?: ComponentConfig<typeof Code>;
    /**
     ...
     * - File upload config
     */
    fileUpload?: ComponentConfig<typeof FileUpload>;
    /**
     * - Header config
     */
    header?: ComponentConfig<typeof Header>;
    /**
     ...
     */
    passwordInput?: ComponentConfig<typeof PasswordInput>;
    /**
     * - Radios config
     */
    radios?: ComponentConfig<typeof Radios>;
    /**
     * - Scroll config
     */
    scroll?: ComponentConfig<typeof Scroll>;
    /**
     * - Section navigation config
     */
    sectionNavigation?: ComponentConfig<typeof SectionNavigation>;
    /**
     * - Skip Link config
     */
    skipLink?: ComponentConfig<typeof SkipLink>;
    /**
     * - Table config
     */
    table?: ComponentConfig<typeof Table>;
    /**
     * - Tabs config
     */
    tabs?: ComponentConfig<typeof Tabs>;
};
/**
...
import { Checkboxes } from './components/index.mjs';
import { Code } from './components/index.mjs';
import { ErrorSummary } from './components/index.mjs';
import { FileUpload } from './components/index.mjs';
import { Header } from './components/index.mjs';
import { NotificationBanner } from './components/index.mjs';
import { PasswordInput } from './components/index.mjs';
import { Radios } from './components/index.mjs';
import { Scroll } from './components/index.mjs';
import { SectionNavigation } from './components/index.mjs';
import { SkipLink } from './components/index.mjs';
import { Table } from './components/index.mjs';
import { Tabs } from './components/index.mjs';
