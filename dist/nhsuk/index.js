...
function initAll($scope) {
  ...
  skipLink.initSkipLink(options);
  button.initButton(options);
  characterCount.initCharacterCount(options);
...
exports.initSkipLink = skipLink.initSkipLink;
exports.Button = button.Button;
exports.initButton = button.initButton;
exports.CharacterCount = characterCount.CharacterCount;
exports.initCharacterCount = characterCount.initCharacterCount;
