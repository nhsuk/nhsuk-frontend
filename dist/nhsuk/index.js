...
function initAll(scopeOrConfig = {}) {
  ...
  const components = /** @type {const} */[[button.Button, config.button], [characterCount.CharacterCount, config.characterCount], [checkboxes.Checkboxes], [errorSummary.ErrorSummary, config.errorSummary], [header.Header], [notificationBanner.NotificationBanner, config.notificationBanner], [passwordInput.PasswordInput, config.passwordInput], [radios.Radios], [skipLink.SkipLink], [tabs.Tabs]];
