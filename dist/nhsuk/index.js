...
var scroll = require('./components/scroll/scroll.js');
var sectionNavigation = require('./components/section-navigation/section-navigation.js');
var skipLink = require('./components/skip-link/skip-link.js');
var table = require('./components/tables/table.js');
...
var extractConfigByNamespace = require('./common/configuration/extract-config-by-namespace.js');
...
function initAll(scopeOrConfig = {}) {
  const config = index$1.isObject(scopeOrConfig) ? scopeOrConfig : {};
  ...
  const components = /** @type {const} */[[button.Button, config.button], [characterCount.CharacterCount, config.characterCount], [checkboxes.Checkboxes, config.checkboxes], [code.Code, config.code], [errorSummary.ErrorSummary, config.errorSummary], [fileUpload.FileUpload, config.fileUpload], [header.Header, config.header], [notificationBanner.NotificationBanner, config.notificationBanner], [passwordInput.PasswordInput, config.passwordInput], [radios.Radios, config.radios], [scroll.Scroll, config.scroll], [sectionNavigation.SectionNavigation, config.sectionNavigation], [skipLink.SkipLink, config.skipLink], [table.Table, config.table], [tabs.Tabs, config.tabs]];
...
exports.formatErrorMessage = index$1.formatErrorMessage;
exports.getBreakpoint = index$1.getBreakpoint;
exports.isInitialised = index$1.isInitialised;
exports.isObject = index$1.isObject;
exports.isScope = index$1.isScope;
exports.isSupported = index$1.isSupported;
exports.setFocus = index$1.setFocus;
exports.toggleConditionalInput = index$1.toggleConditionalInput;
exports.ConfigError = index.ConfigError;
exports.ElementError = index.ElementError;
exports.InitError = index.InitError;
exports.NHSUKFrontendError = index.NHSUKFrontendError;
exports.SupportError = index.SupportError;
...
exports.SectionNavigation = sectionNavigation.SectionNavigation;
