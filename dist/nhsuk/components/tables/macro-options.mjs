  ...
  head: {
    ...
    params: {
      ...
      initialSortColumn: {
        type: 'boolean',
        required: false,
        description: 'Set to true if this column is sorted on initial page load. Use `sortFirstDirection` to set the initial direction. Must only be set on a single column.',
        released: '10.6.0'
      },
      sortFirstDirection: {
        type: 'string',
