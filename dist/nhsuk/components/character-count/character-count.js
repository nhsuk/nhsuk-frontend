...
class CharacterCount {
  ...
  constructor($root) {
    ...
    // Check for module
    const $fallbackLimitMessage = document.getElementById(`${this.$textarea.id}-info`);
 ...
 */
function initCharacterCount(options = {}) {
...
exports.initCharacterCount = initCharacterCount;
