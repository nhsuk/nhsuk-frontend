...
const options = {
  ...
  fieldset: {
    type: 'object',
    required: false,
    description: 'The fieldset used by the radios component. The `fieldset.html` option is not supported.',
    released: '1.0.0',
    isComponent: true
  },
  hint: {
  ...
  items: {
    ...
    params: {
      ...
      label: {
        type: 'object',
        required: false,
        description: 'The label used by each radio item within the radios component. The `label.size` and `label.isPageHeading` options are not supported.',
        released: '1.0.0',
        isComponent: true
      },
      hint: {
  ...
  disabled: {
    type: 'boolean',
    required: false,
    description: 'If `true`, radio inputs used by the radios component will be disabled.',
    released: '10.5.0'
  },
  small: {
    type: 'boolean',
