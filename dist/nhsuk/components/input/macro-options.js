...
const options = {
  ...
  type: {
    type: 'string',
    required: false,
    description: 'Type of input control, for example, an email input control. Defaults to `"text"`.',
    released: '1.0.0'
  },
  inputmode: {
    type: 'string',
  ...
  variant: {
    type: 'string',
    required: false,
    description: 'Optional variant of input. You can use only `"reverse"` or empty values with this option.',
    released: '10.5.0'
  },
  formGroup: {
    type: 'object',
