...
const options = {
  ...
  fieldset: {
    type: 'object',
    required: false,
    description: 'Can be used to add a fieldset to the checkboxes component. The `fieldset.html` option is not supported.',
    released: '1.0.0',
    isComponent: true
  },
  hint: {
  ...
  items: {
    ...
    params: {
      ...
      name: {
        type: 'string',
        required: false,
        description: 'Specific `name` attribute for the checkbox item. If omitted, then component global `name` string will be applied.',
        released: '1.0.0'
      },
      value: {
        type: 'string',
      ...
      label: {
        type: 'object',
        required: false,
        description: 'The label used by each checkbox item within the checkboxes component. The `label.size` and `label.isPageHeading` options are not supported.',
        released: '1.0.0',
        isComponent: true
      },
      hint: {
      ...
      behaviour: {
        type: 'string',
        required: false,
        description: 'Behaviour of the checkbox when JavaScript is enabled – `"exclusive"` or `"inclusive"`. Use `"exclusive"` for a "none" option or `"inclusive"` for an "all" option.',
        released: '10.6.0'
      },
      behaviourGroup: {
        type: 'string',
        required: false,
        description: 'Used in conjunction with `behaviour` - this should be set to a string which groups checkboxes together into a set for use with a "none" or "all" option.',
        released: '10.6.0'
      },
      exclusive: {
        type: 'boolean',
        required: false,
        description: 'If set to `true`, marks this checkbox as an exclusive "none" option. Unchecking all other checkboxes in the group when clicked. Replaced by the `behaviour` option.',
        released: '5.2.0',
        deprecated: '10.6.0'
      },
      exclusiveGroup: {
        type: 'string',
        required: false,
        description: 'Used in conjunction with `exclusive` - this should be set to a string which groups checkboxes together into a set for use with a "none" option. Replaced by the `behaviourGroup` option.',
        released: '5.2.0',
        deprecated: '10.6.0'
      }
    }
  ...
  disabled: {
    type: 'boolean',
    required: false,
    description: 'If `true`, checkbox inputs used by the checkboxes component will be disabled.',
    released: '10.5.0'
  },
  small: {
    type: 'boolean',
