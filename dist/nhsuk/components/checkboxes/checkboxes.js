...
class Checkboxes {
  ...
  syncAllConditionalReveals() {
    this.$inputs.forEach(item => common.toggleConditionalInput(item, 'nhsuk-checkboxes__conditional--hidden'));
  }
  ...
  unCheckAllInputsExcept(input) {
    const allInputsInSameExclusiveGroup = input.form.querySelectorAll(`input[type="checkbox"][data-checkbox-exclusive-group="${input.getAttribute('data-checkbox-exclusive-group')}"]`);
  ...
  unCheckExclusiveInputs(input) {
    const allExclusiveInputsInSameExclusiveGroup = input.form.querySelectorAll(`input[type="checkbox"][data-checkbox-exclusive][data-checkbox-exclusive-group="${input.getAttribute('data-checkbox-exclusive-group')}"]`);
  ...
  handleClick(event) {
    ...
    common.toggleConditionalInput(event.target, 'nhsuk-checkboxes__conditional--hidden');
