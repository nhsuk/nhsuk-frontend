...
const options = {
  ...
  type: {
    type: 'string',
    required: false,
    description: 'Type of `button` – `"button"` or `"submit"`. Defaults to `"submit"`. This has no effect on `a` elements.',
    released: '10.5.0'
  },
  href: {
    type: 'string',
  ...
  openInNewWindow: {
    type: 'boolean',
    required: false,
    description: 'If set to `true`, then the link will open in a new window. This has no effect on `button` elements.',
    released: '1.0.0'
  },
  variant: {
    type: 'string',
  ...
  element: {
    type: 'string',
    required: false,
    description: 'HTML element for the action link component – `"button"` or `"a"`. Defaults to `"a"`.',
    released: '10.5.0'
  }
};
