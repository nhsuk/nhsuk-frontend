...
const options = {
  ...
  items: {
    ...
    params: {
      id: {
        type: 'string',
        required: false,
        description: 'Item-specific `id` attribute. If provided, it will be used instead of the generated ID.'
      },
      name: {
        type: 'string',
        required: true,
      ...
      inputmode: {
        type: 'string',
        required: false,
        description: 'Optional value for [the `inputmode` attribute](https://developer.mozilla.org/en-US/docs/Web/HTML/Global_attributes/inputmode). Defaults to `"numeric"`.'
      },
      value: {
        type: 'string',
        required: false,
        description: 'If provided, it will be used as the initial `value` attribute of the input.'
      },
      autocomplete: {
        type: 'string',
        required: false,
  ...
  values: {
    type: 'object',
    required: false,
    description: 'An optional object use to specify `value` attributes for the date parts without setting items.',
    params: {
      day: {
        type: 'string',
        required: false,
