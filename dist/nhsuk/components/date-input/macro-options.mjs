...
const options = {
  ...
  namePrefix: {
    type: 'string',
    required: false,
    description: 'Optional prefix. This is used to prefix each date input `name` attribute, wrapped in `[` and `]` – for example, `namePrefix: "dob"` will output the `name` attributes `dob[day]`, `dob[month]` and `dob[year]` respectively.',
    released: '1.0.0'
  },
  items: {
    type: 'array',
    ...
    params: {
      ...
      label: {
        type: 'object',
        required: false,
        description: 'Item-specific label. The `label.size` and `label.heading` options are not supported. Defaults to the `name` option capitalised.',
        released: '10.5.0',
        isComponent: true
      },
      error: {
  ...
  day: {
    ...
    params: {
      ...
      label: {
        type: 'object',
        required: false,
        description: 'The label used by the day input. The `label.size` and `label.heading` options are not supported. Defaults to the `name` option capitalised.',
        released: '10.5.0',
        isComponent: true
      },
      error: {
  ...
  month: {
    ...
    params: {
      ...
      label: {
        type: 'object',
        required: false,
        description: 'The label used by the month input. The `label.size` and `label.heading` options are not supported. Defaults to the `name` option capitalised.',
        released: '10.5.0',
        isComponent: true
      },
      error: {
  ...
  year: {
    ...
    params: {
      ...
      label: {
        type: 'object',
        required: false,
        description: 'The label used by the year input. The `label.size` and `label.heading` options are not supported. Defaults to the `name` option capitalised.',
        released: '10.5.0',
        isComponent: true
      },
      error: {
