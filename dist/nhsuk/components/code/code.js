 ...
 */
class Code extends configurableComponent.ConfigurableComponent {
  /**
  ...
  static checkSupport($root, config) {
    configurableComponent.ConfigurableComponent.checkSupport($root, config);
    ...
    if (!('clipboard' in navigator)) {
      ...
      throw new index.SupportError(index$1.formatErrorMessage(Code, 'Support for "navigator.clipboard" required'));
    }
  }
