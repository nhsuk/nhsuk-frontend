...
const options = {
  ...
  rows: {
    ...
    params: {
      ...
      attributes: {
        type: 'string',
        required: false,
        description: 'HTML attributes (for example data attributes) to add to the row.',
        released: '10.6.0'
      },
      border: {
        type: 'boolean',
      ...
      key: {
        ...
        params: {
          ...
          width: {
            type: 'string',
            required: false,
            description: 'Specify the key wrapper width. You can pass any design system grid width here – for example, `"one-third"`, `"two-thirds"` or `"one-half"`.',
            released: '10.6.0'
          },
          classes: {
            type: 'string',
          ...
          attributes: {
            type: 'string',
            required: false,
            description: 'HTML attributes (for example data attributes) to add to the key wrapper.',
            released: '10.6.0'
          }
        }
      },
      value: {
        ...
        params: {
          ...
          width: {
            type: 'string',
            required: false,
            description: 'Specify the value wrapper width. You can pass any design system grid width here – for example, `"one-third"`, `"two-thirds"` or `"one-half"`.',
            released: '10.6.0'
          },
          classes: {
            type: 'string',
          ...
          attributes: {
            type: 'string',
            required: false,
            description: 'HTML attributes (for example data attributes) to add to the value wrapper.',
            released: '10.6.0'
          }
        }
      },
      actions: {
        ...
        params: {
          items: {
            ...
            params: {
              ...
              name: {
                type: 'string',
                required: false,
                description: 'Name for the action as a button. If `type` is set, this has no effect.',
                released: '10.6.0'
              },
              type: {
                type: 'string',
              ...
              value: {
                type: 'string',
                required: false,
                description: 'The `value` attribute for the action as a button. If `type` is set, this has no effect.',
                released: '10.6.0'
              },
              href: {
                type: 'string',
          ...
          width: {
            type: 'string',
            required: false,
            description: 'Specify the actions wrapper width. You can pass any design system grid width here – for example, `"one-third"`, `"two-thirds"` or `"one-half"`.',
            released: '10.6.0'
          },
          classes: {
            type: 'string',
          ...
          attributes: {
            type: 'string',
            required: false,
            description: 'HTML attributes (for example data attributes) to add to the actions wrapper.',
            released: '10.6.0'
          }
        }
      }
  ...
  caller: {
    type: 'nunjucks-block',
    required: false,
    description: 'Not strictly an option but supports the [`call` block](https://mozilla.github.io/nunjucks/templating.html#call) as an alternative to the `html` option. To use it, you will need to wrap the entire summary list component in a `call` block.',
    released: '10.6.0'
  },
  card: {
    type: 'object',
