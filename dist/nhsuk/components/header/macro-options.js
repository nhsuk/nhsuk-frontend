      ...
      items: {
        ...
        params: {
          ...
          text: {
            type: 'string',
            required: true,
            description: 'If `html` is set, this is not required. Text for the navigation item. If `html` is provided, the `text` option will be ignored.',
            released: '10.0.0'
          },
          html: {
            type: 'string',
            required: true,
            description: 'If `text` is set, this is not required. HTML for the navigation item. If `html` is provided, the `text` option will be ignored.',
            released: '10.0.0'
          },
          current: {
            type: 'boolean',
  ...
  search: {
    ...
    params: {
      ...
      name: {
        type: 'string',
        required: false,
        description: 'The `name` attribute for the search input. Defaults to `"q"`.',
        released: '10.0.0'
      },
      placeholder: {
        type: 'string',
      ...
      visuallyHiddenLabel: {
        type: 'string',
        required: false,
        description: 'Replaced by the `search.label.visuallyHiddenText` option.',
        released: '10.0.0',
        deprecated: '10.6.0'
      },
      ...
      label: {
        type: 'object',
        required: false,
        description: 'Optional object allowing customisation of the search input label.',
        released: '10.6.0',
        isComponent: true,
        params: {
          visuallyHiddenText: {
            type: 'string',
            required: false,
            description: 'The visually hidden label text for the search input. Defaults to `"Search the NHS website"`.',
            released: '10.6.0'
          }
        }
      },
      input: {
        type: 'object',
        required: false,
        description: 'Optional object allowing customisation of the search input.',
        released: '10.6.0',
        isComponent: true,
        params: {
          placeholder: {
            type: 'string',
            required: false,
            description: 'The placeholder text for the search input. Defaults to `"Search"`.',
            released: '10.6.0'
          }
        }
      },
      button: {
        ...
        params: {
          ariaLabel: {
            type: 'string',
            required: false,
            description: 'Search button text exposed to assistive technologies, like screen readers, when only an icon is used. Defaults to `"Search"`.',
            released: '10.6.0'
          }
        }
      },
      ...
      items: {
        ...
        params: {
          ...
          text: {
            type: 'string',
            required: true,
            description: 'If `html` is set, this is not required. Text for the account item. If `html` is provided, the `text` option will be ignored.',
            released: '10.0.0'
          },
          html: {
            type: 'string',
            required: true,
            description: 'If `text` is set, this is not required. HTML for the account item. If `html` is provided, the `text` option will be ignored.',
            released: '10.0.0'
          },
          icon: {
            type: 'boolean',
