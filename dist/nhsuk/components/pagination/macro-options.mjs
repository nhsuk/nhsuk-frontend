...
const options = {
  ...
  previousUrl: {
    type: 'string',
    required: false,
    description: "The previous page's URL. Replaced by the `previous.href` option.",
    released: '1.0.0',
    deprecated: '10.1.0'
  },
  previousPage: {
    type: 'string',
    required: false,
    description: 'The optional label that goes underneath the link to the previous page, providing further context for the user about where the link goes. Replaced by the `previous.labelText` option.',
    released: '1.0.0',
    deprecated: '10.1.0'
  },
  next: {
  ...
  nextPage: {
    type: 'string',
    required: false,
    description: 'The optional label that goes underneath the link to the next page, providing further context for the user about where the link goes. Replaced by the `next.labelText` option.',
    released: '1.0.0',
    deprecated: '10.1.0'
  },
  landmarkLabel: {
