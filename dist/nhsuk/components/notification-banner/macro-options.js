...
const options = {
  ...
  title: {
    ...
    params: {
      ...
      text: {
        type: 'string',
        required: true,
        description: 'If `html` is set, this is not required. Text for the title. If `html` is provided, the `text` option will be ignored.',
        released: '10.6.0'
      },
      html: {
        type: 'string',
        required: true,
        description: 'If `text` is set, this is not required. HTML for the title. If `html` is provided, the `text` option will be ignored.',
        released: '10.6.0'
      },
      visuallyHiddenText: {
        type: 'string',
      ...
      attributes: {
        type: 'object',
        required: false,
        description: 'HTML attributes (for example data attributes) to add to the title.',
        released: '10.6.0'
      }
    }
  },
  ...
  heading: {
    ...
    params: {
      ...
      element: {
        type: 'string',
        required: false,
        description: 'HTML element for the heading – for example, `"p"`. Defaults to the `level` option prefixed with `"h"`.',
        released: '10.6.0'
      }
    }
  },
  ...
  caller: {
    type: 'nunjucks-block',
    required: false,
    description: 'Not strictly an option but supports the [`call` block](https://mozilla.github.io/nunjucks/templating.html#call) as an alternative to the `html` option. To use it, you will need to wrap the entire notification banner component in a `call` block.',
    released: '10.0.0'
  },
  variant: {
    type: 'string',
