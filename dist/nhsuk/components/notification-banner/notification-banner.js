 ...
 */
class NotificationBanner extends component.Component {
  /**
  ...
  constructor($root) {
     ...
     */
    this.config = Object.assign({}, NotificationBanner.defaults, NotificationBanner.getDataset(this.$root));
...
function initNotificationBanners(options = {}) {
  ...
  const $notificationBanners = $scope.querySelectorAll(`[data-module="${NotificationBanner.moduleName}"]`);
