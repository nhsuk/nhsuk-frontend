 ...
 */
export function initNotificationBanners(options?: InitOptions & Partial<NotificationBannerConfig>): void;
/**
...
export class NotificationBanner extends ConfigurableComponent<NotificationBannerConfig, HTMLElement> {
     ...
     */
    constructor($root: Element | null, config?: Partial<NotificationBannerConfig>);
}
/**
