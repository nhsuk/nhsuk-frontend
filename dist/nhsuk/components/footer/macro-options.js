...
const options = {
      ...
      items: {
        ...
        params: {
          ...
          attributes: {
            type: 'object',
            required: false,
            description: 'HTML attributes (for example data attributes) to add to the footer navigation link.',
            released: '10.0.0'
          }
        }
      }
  ...
  caller: {
    type: 'nunjucks-block',
    required: false,
    description: 'Not strictly an option but supports the [`call` block](https://mozilla.github.io/nunjucks/templating.html#call) as an alternative to the `html` option. To use it, you will need to wrap the entire footer component in a `call` block.',
    released: '10.0.0'
  },
  attributes: {
    type: 'object',
