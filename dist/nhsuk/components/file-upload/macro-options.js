...
const options = {
  ...
  chooseFilesButtonClassList: {
    type: 'array',
    required: false,
    description: 'Classes to add to the button that opens the file picker. Default is `["nhsuk-button--secondary"]`.'
  },
  chooseFilesButtonText: {
    type: 'string',
    required: false,
    description: 'The text of the button that opens the file picker. Default is `"Choose file"`.'
  },
  dropInstructionText: {
    type: 'string',
    required: false,
    description: 'The text informing users they can drop files. Default is `"or drop file"`.'
  },
  ...
  noFileChosenText: {
    type: 'string',
    required: false,
    description: 'The text displayed when no file has been chosen by the user. Default is `"No file chosen"`.'
  },
  enteredDropZoneText: {
    type: 'string',
    required: false,
    description: 'The text announced by assistive technology when user drags files and enters the drop zone. Default is `"Entered drop zone"`.'
  },
  leftDropZoneText: {
    type: 'string',
    required: false,
    description: 'The text announced by assistive technology when user drags files and leaves the drop zone without dropping. Default is `"Left drop zone"`.'
  },
  classes: {
    type: 'string',
    required: false,
