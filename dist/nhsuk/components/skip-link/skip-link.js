...
class SkipLink {
  ...
  constructor($root) {
    ...
    const $linkedElement = linkedElementId ? document.getElementById(linkedElementId) : null;
     ...
     */
    this.$root.addEventListener('click', () => common.setFocus($linkedElement, {
      onBeforeFocus() {
