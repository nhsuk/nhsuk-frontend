...
const options = {
  ...
  description: {
    ...
    params: {
      text: {
        type: 'string',
        required: true,
        description: 'If `html` is set, this is not required. Text to use for the description of the errors. If `html` is provided, the `text` option will be ignored.',
        released: '10.6.0'
      },
      html: {
        type: 'string',
        required: true,
        description: 'If `text` is set, this is not required. HTML to use for the description of the errors. If `html` is provided, the `text` option will be ignored.',
        released: '10.6.0'
      },
      classes: {
        type: 'string',
      ...
      attributes: {
        type: 'object',
        required: false,
        description: 'HTML attributes (for example data attributes) to add to the error summary body.',
        released: '10.6.0'
      }
    }
  },
  ...
  caller: {
    type: 'nunjucks-block',
    required: false,
    description: 'Not strictly an option but supports the [`call` block](https://mozilla.github.io/nunjucks/templating.html#call) as an alternative to the `html` option. To use it, you will need to wrap the entire error summary component in a `call` block.',
    released: '9.5.0'
  },
  errorList: {
    type: 'array',
    ...
    params: {
      href: {
        type: 'string',
        required: false,
        description: 'The error `href` attribute. If set, the error will become a link.',
        released: '1.0.0'
      },
      text: {
        type: 'string',
      ...
      attributes: {
        type: 'object',
        required: false,
        description: 'HTML attributes (for example data attributes) to add to the error link.',
        released: '1.0.0'
      }
    }
  },
