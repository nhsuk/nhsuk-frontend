...
import { examples as examples$1 } from '../images/fixtures.mjs';
import { examples as examples$2 } from '../summary-list/fixtures.mjs';
...
const fixtures = {
  ...
  'basic with summary list': {
    ...
    callBlock: outdent`
      ${components.render('summary-list', examples$2['example person: Karen Francis (no border)'])}
    `,
    screenshot: {
  ...
  'basic with summary lists': {
    ...
    callBlock: outdent`
      ...
      ${components.render('summary-list', examples$2['example person: Karen Francis'])}

      <h4 class="nhsuk-heading-s nhsuk-u-margin-bottom-1">West</h4>
      ${components.render('summary-list', examples$2['example person: Sarah Philips (no border)'])}
    `,
    screenshot: {
      viewports: ['mobile', 'tablet']
    }
  ...
  'with image and caption': {
    context: {
      image: {
        html: components.render('images', examples$1['default'])
      },
      href: '#',
      clickable: true,
      heading: 'Exercise',
