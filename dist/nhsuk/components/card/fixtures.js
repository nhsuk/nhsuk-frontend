...
const fixtures = {
  ...
  'basic with summary list': {
    ...
    callBlock: outdent.outdent(_t3 || (_t3 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
          key: {
            text: 'Name'
  ...
  'basic with summary list and button': {
    ...
    callBlock: outdent.outdent(_t5 || (_t5 = _`
      ${0}
  ...
  'basic with summary list and actions': {
    ...
    callBlock: outdent.outdent(_t6 || (_t6 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'basic with summary list and actions, without heading': {
    ...
    callBlock: outdent.outdent(_t7 || (_t7 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'basic with summary list and actions (empty items)': {
    ...
    callBlock: outdent.outdent(_t8 || (_t8 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'basic with summary list and heading link': {
    ...
    callBlock: outdent.outdent(_t9 || (_t9 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'secondary with custom HTML': {
    ...
    callBlock: outdent.outdent(_t0 || (_t0 = _`
      <p class="nhsuk-body">If you're worried about a symptom and not sure what help you need, NHS 111 can tell you what to do next.</p>
      <p class="nhsuk-body">Go to <a href="#">111.nhs.uk</a> or <a href="#">call 111</a>.</p>
      <p class="nhsuk-body">For a life-threatening emergency call 999.</p>
    `))
  ...
  'secondary with summary list': {
    ...
    callBlock: outdent.outdent(_t1 || (_t1 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'secondary with summary lists': {
    ...
    callBlock: outdent.outdent(_t10 || (_t10 = _`
      <h4 class="nhsuk-heading-s nhsuk-u-margin-bottom-1">East</h4>
      ${0}
  ...
  'secondary with summary list and button': {
    ...
    callBlock: outdent.outdent(_t11 || (_t11 = _`
      ${0}
  ...
  'secondary with summary list and actions': {
    ...
    callBlock: outdent.outdent(_t12 || (_t12 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'secondary with summary list and actions, without heading': {
    ...
    callBlock: outdent.outdent(_t13 || (_t13 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'secondary with summary list and actions (empty items)': {
    ...
    callBlock: outdent.outdent(_t14 || (_t14 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'secondary with summary list and heading link': {
    ...
    callBlock: outdent.outdent(_t15 || (_t15 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'non-urgent (blue)': {
    ...
    callBlock: outdent.outdent(_t16 || (_t16 = _`
      <ul>
  ...
  'urgent (red)': {
    ...
    callBlock: outdent.outdent(_t17 || (_t17 = _`
      <ul>
  ...
  'emergency (red and black)': {
    ...
    callBlock: outdent.outdent(_t18 || (_t18 = _`
      <ul>
  ...
  'emergency (red and black) with action link': {
    ...
    callBlock: outdent.outdent(_t19 || (_t19 = _`
      <ul>
      ...
      ${0}
    `), _lib.components.render('action-link', {
      context: {
  ...
  'secondary non-clickable with custom description': {
    context: {
      ...
      descriptionHtml: outdent.outdent(_t20 || (_t20 = _`
  ...
  'feature with A to Z content': {
    context: {
      ...
      headingId: 'a',
      headingSize: 'm',
      descriptionHtml: outdent.outdent(_t21 || (_t21 = _`
  ...
  'feature with summary list': {
    ...
    callBlock: outdent.outdent(_t22 || (_t22 = _`
      ${0}
    `), _lib.components.render('summary-list', {
      context: {
        rows: [{
  ...
  'feature with nested card and summary list': {
    ...
    callBlock: outdent.outdent(_t23 || (_t23 = _`
    ...
    `), _lib.components.render('summary-list', {
      context: {
        ...
        rows: [{
          ...
          value: {
            html: _lib.components.render('tag', {
              context: {
  ...
  'with image and caption': {
    context: {
      image: {
        html: _lib.components.render('images', {
          context: {
            src: 'https://assets.nhs.uk/prod/images/A_0218_exercise-main_FKW1X7.width-690.jpg',
            caption: {
  ...
  'with image and custom HTML': {
    context: {
      ...
      heading: 'Why we are reinvesting in the NHS prototype kit',
      headingSize: 'm',
      headingHtml: outdent.outdent(_t24 || (_t24 = _`
