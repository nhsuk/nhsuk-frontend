...
var fixtures$1 = require('../images/fixtures.js');
var fixtures$2 = require('../summary-list/fixtures.js');
...
const fixtures = {
  ...
  "basic with summary list": {
    ...
    callBlock: outdent.outdent`
      ${_lib.components.render("summary-list", fixtures$2.examples["example person: Karen Francis (no border)"])}
    `,
    screenshot: {
  ...
  "basic with summary lists": {
    ...
    callBlock: outdent.outdent`
      ...
      ${_lib.components.render("summary-list", fixtures$2.examples["example person: Karen Francis"])}

      <h4 class="nhsuk-heading-s nhsuk-u-margin-bottom-1">West</h4>
      ${_lib.components.render("summary-list", fixtures$2.examples["example person: Sarah Philips (no border)"])}
    `,
    screenshot: {
      viewports: ["mobile", "tablet"]
    }
  ...
  "secondary non-clickable with custom description": {
    context: {
      ...
      descriptionHtml: outdent.outdent`
  ...
  "with image and caption": {
    context: {
      image: {
        html: _lib.components.render("images", fixtures$1.examples["default"])
      },
      href: "#",
      clickable: true,
      heading: "Exercise",
