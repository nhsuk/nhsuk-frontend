...
const options = {
  ...
  prefix: {
    type: 'object',
    required: false,
    description: 'Can be used to add a prefix to the password input component.',
    released: '10.5.0',
    params: {
      text: {
        type: 'string',
  ...
  suffix: {
    type: 'object',
    required: false,
    description: 'Can be used to add a suffix to the password input component.',
    released: '10.5.0',
    params: {
      text: {
        type: 'string',
  ...
  width: {
    type: 'integer',
    required: false,
    description: 'Optional fixed width for the text input component – `2`, `3`, `4`, `5`, `10`, `20` or `30`.',
    released: '10.2.0'
  },
  large: {
    type: 'boolean',
  ...
  inputWrapper: {
    type: 'object',
    required: false,
    description: 'Additional options for the wrapping element containing the password input component.',
    released: '10.5.0',
    params: {
      classes: {
        type: 'string',
  ...
  button: {
    type: 'object',
    required: false,
    description: 'Optional object allowing customisation of the toggle button. The `button.attributes` and `button.html` options are not supported.',
    released: '10.2.0',
    isComponent: true,
    params: {
      variant: {
        type: 'string',
        required: false,
        description: 'Optional variant of password input button – `"brand"`, `"login"`, `"reverse"`, `"secondary"`, `"secondary-solid"` or `"warning"`.',
        released: '10.5.0'
      },
      classes: {
        type: 'string',
