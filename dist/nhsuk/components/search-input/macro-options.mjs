...
const options = {
  ...
  type: {
    type: 'string',
    required: false,
    description: 'Type of input control, for example, an email input control. Defaults to `"search"`.',
    released: '10.5.0'
  },
  inputmode: {
    type: 'string',
  ...
  spellcheck: {
    type: 'boolean',
    required: false,
    description: 'Optional field to enable or disable the `spellcheck` attribute on the search input.',
    released: '10.5.0'
  },
  autocapitalize: {
    type: 'string',
    required: false,
    description: 'Optional field to enable or disable autocapitalisation of user input. See the [Autocapitalization section in the HTML standard](https://html.spec.whatwg.org/multipage/interaction.html#autocapitalization) for a full list of values that can be used.',
    released: '10.5.0'
  },
  inputWrapper: {
    type: 'object',
  ...
  button: {
    ...
    params: {
      variant: {
        type: 'string',
        required: false,
        description: 'Optional variant of search button – `"brand"`, `"brand-reverse"`, `"login"`, `"reverse"`, `"secondary"`, `"secondary-solid"` or `"warning"`.',
        released: '10.5.0'
      },
      classes: {
        type: 'string',
