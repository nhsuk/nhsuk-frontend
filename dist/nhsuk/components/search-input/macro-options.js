...
const options = {
  ...
  variant: {
    type: 'string',
    required: false,
    description: 'Optional variant of search input. You can use only `"reverse"` or empty values with this option.',
    released: '10.5.0'
  },
  formGroup: {
    type: 'object',
  ...
  button: {
    ...
    params: {
      variant: {
        type: 'string',
        required: false,
        description: 'Optional variant of search button – `"login"`, `"search"`, `"reverse"`, `"secondary"`, `"secondary-solid"` or `"warning"`.',
        released: '10.5.0'
      },
      classes: {
        type: 'string',
