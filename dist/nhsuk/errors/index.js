...
class InitError extends NHSUKFrontendError {
  ...
  constructor(componentOrMessage) {
    cov_3il548hwv().f[2]++;
    const message = (cov_3il548hwv().s[13]++, typeof componentOrMessage === 'string' ? (cov_3il548hwv().b[6][0]++, componentOrMessage) : (cov_3il548hwv().b[6][1]++, index.formatErrorMessage(componentOrMessage, 'Root element (`$root`) already initialised')));
    cov_3il548hwv().s[14]++;
    super(message);
