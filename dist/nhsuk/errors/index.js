...
class InitError extends NHSUKFrontendError {
  ...
  constructor(componentOrMessage) {
    cov_10yqi595qc().f[2]++;
    const message = (cov_10yqi595qc().s[13]++, typeof componentOrMessage === 'string' ? (cov_10yqi595qc().b[6][0]++, componentOrMessage) : (cov_10yqi595qc().b[6][1]++, index.formatErrorMessage(componentOrMessage, 'Root element (`$root`) already initialised')));
    cov_10yqi595qc().s[14]++;
    super(message);
