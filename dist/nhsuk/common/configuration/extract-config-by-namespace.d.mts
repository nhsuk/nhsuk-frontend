...
export type Schema<ConfigurationType extends Partial<Record<keyof ConfigurationType, unknown>>> = {
    ...
    /**
     * - List of schema conditions, all must pass
     */
    allOf?: SchemaCondition<ConfigurationType>[] | undefined;
    /**
     * - List of schema conditions, any must pass
     */
...
export type NestedValue = string | boolean | number;
export type ObjectNested = {
    [key: string]: NestedValue | NestedValue[] | ((...args: any[]) => NestedValue) | ObjectNested | undefined;
};
