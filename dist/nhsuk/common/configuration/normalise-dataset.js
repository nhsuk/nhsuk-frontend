...
function normaliseDataset(Component, dataset) {
  ...
  for (const entry of entries) {
    ...
    if (field in dataset) {
      ...
      cov_13thkhr9yv().s[8]++;
      out[field] = (property == null ? void 0 : property.type) === 'array' ? (cov_13thkhr9yv().b[2][0]++, normaliseString.normaliseArray(dataset[field])) : (cov_13thkhr9yv().b[2][1]++, normaliseString.normaliseString(dataset[field], property));
    } else {
