...
class ConfigurableComponent extends component.Component {
  ...
  constructor($root, config) {
    ...
    const datasetConfig = (/** @type {Partial<ConfigurationType>} */cov_w6r9t1pl2().s[4]++, normaliseDataset.normaliseDataset(childConstructor, this.$root.dataset));

    // Override defaults with JavaScript config
    cov_w6r9t1pl2().s[5]++;
    this.config = /** @type {ConfigurationType} */
    mergeConfigs.mergeConfigs(childConstructor.defaults, (_ref = (cov_w6r9t1pl2().b[1][0]++, config)) != null ? _ref : (cov_w6r9t1pl2().b[1][1]++, {}));
