...
To use the font you must have a licence. NHS England has a licence for the Frutiger webfont which can be used by all NHS organisations in England. [NHS organisations can register here](https://service-manual.nhs.uk/design-system/styles/use-frutiger-font/)
