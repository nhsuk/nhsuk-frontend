 ...
 * @param {ConfigurableComponentConstructor} Component - Component class
...
/**
 * @import { ConfigurableComponentConstructor, SchemaProperty } from '../../configurable-component.mjs'
 */
