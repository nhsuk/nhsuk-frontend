  ...
  describe('importing using index file', () => {
    const properties = outdent`
      :root {
        ...
        --nhsuk-reverse-card-background-colour: #0055a6;
        ...
        --nhsuk-reverse-error-colour: #f6d0cd;
        --nhsuk-reverse-error-border-colour: #eda59f;
        ...
        --nhsuk-reverse-input-border-colour: #4d8ecd;
        ...
        --nhsuk-reverse-input-background-colour: #0055a6;
