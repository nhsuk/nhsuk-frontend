export const name = 'Stepper input'
...
const options = {
  ...
  min: {
    type: 'number',
    required: false,
    description: 'The `min` attribute for the `input` tag.'
  },
  max: {
    type: 'number',
    required: false,
    description: 'The `max` attribute for the `input` tag.'
  },
  step: {
    type: 'number',
    required: false,
    description: 'The `step` attribute for the `input` tag.'
  },
  disabled: {
    type: 'boolean',
    required: false,
  ...
  stepDownButton: {
    ...
    required: false,
    description:
      'Optional object allowing customisation of the step down button.',
    params: {
      classes: {
        type: 'string',
        required: false,
        description: 'Classes to add to the step down button.'
      },
      text: {
        type: 'string',
        required: false,
        description:
          'Text to use within the step down button. If `html` is provided, the `text` and `ariaLabel` arguments will be ignored. Defaults to `"Decrease"`.'
      },
      html: {
        type: 'string',
        required: false,
        description:
          'HTML to use within the step down button. If `html` is provided, the `text` and `ariaLabel` arguments will be ignored. Defaults to `"Decrease"`.'
      },
      ariaLabel: {
        type: 'string',
        required: false,
        description:
          'Step down button text exposed to assistive technologies, like screen readers, when only an icon is used. Defaults to `"Decrease"`.'
      },
      variant: {
        type: 'string',
        required: false,
        description:
          'Optional variant of step down button – `"login"`, `"reverse"`, `"search"`, `"secondary"`, `"secondary-solid"` or `"warning"`.'
      }
    }
  },
  stepUpButton: {
    ...
    required: false,
    description:
      'Optional object allowing customisation of the step up button.',
    params: {
      classes: {
        type: 'string',
        required: false,
        description: 'Classes to add to the step up button.'
      },
      text: {
        type: 'string',
        required: false,
        description:
          'Text to use within the step up button. If `html` is provided, the `text` and `ariaLabel` arguments will be ignored. Defaults to `"Increase"`.'
      },
      html: {
        type: 'string',
        required: false,
        description:
          'HTML to use within the step up button. If `html` is provided, the `text` and `ariaLabel` arguments will be ignored. Defaults to `"Increase"`.'
      },
      ariaLabel: {
        type: 'string',
        required: false,
        description:
          'Step up button text exposed to assistive technologies, like screen readers, when only an icon is used. Defaults to `"Increase"`.'
      },
      variant: {
        type: 'string',
        required: false,
        description:
          'Optional variant of step up button – `"login"`, `"reverse"`, `"search"`, `"secondary"`, `"secondary-solid"` or `"warning"`.'
      }
    }
  }
}
