...
const options = {
  ...
  text: {
    ...
    required: true,
    description:
      'If `html` is set, this is not required. Text to use within the heading. If `html` is provided, the `text` option will be ignored.',
    released: '10.6.0'
  },
  html: {
    type: 'string',
    required: true,
    description:
      'If `text` is set, this is not required. HTML to use within the heading. If `html` is provided, the `text` option will be ignored.',
    released: '10.6.0'
  },
  caller: {
    type: 'nunjucks-block',
    required: false,
    description:
      'Not strictly an option but supports the [`call` block](https://mozilla.github.io/nunjucks/templating.html#call) as an alternative to the `html` option. To use it, you will need to wrap the entire heading component in a `call` block.',
    released: '10.6.0'
  },
  visuallyHiddenText: {
    type: 'string',
  ...
  className: {
    ...
    required: false,
    description:
      'Optional class to use for the heading. Defaults to `"nhsuk-heading"`.',
    released: '10.6.0'
  },
  classPrefix: {
    type: 'string',
    required: false,
    description:
      'Optional class prefix to use for the heading. Defaults to `"nhsuk-heading-"`.',
    released: '10.6.0'
  },
  classes: {
    type: 'string',
