...
const options = {
  ...
  href: {
    ...
    required: true,
    description:
      'The value of the link `href` attribute. This has no effect when `type` is set.',
    released: '1.0.0'
  },
  openInNewWindow: {
    type: 'boolean',
    required: false,
    description:
      'If set to `true`, then the link will open in a new window. This has no effect when `type` is set.',
    released: '1.0.0'
  },
  variant: {
    type: 'string',
