...
function autocomplete(config) {
  ...
  function suggestionTemplate(result) {
    ...
    const regx = new RegExp(TypedText, 'g');
    const boldedResult = resultTruncated.replace(regx, '<b>'+TypedText+'</b>')
    ...
    const resultsHref = '<a href="https://www.nhs.uk/search?collection=nhs-meta&query=' + result + '">' + boldedResult + '</a>';
