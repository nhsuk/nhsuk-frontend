...
Find out more about the A-Z list component and when to use it in the [NHS Digital service manual](https://beta.nhs.uk/service-manual/).
...
```html
{% from 'components/a-z-list/macro.njk' import azList %}
