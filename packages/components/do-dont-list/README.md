...
Find out more about the do & don't list component and when to use it in the [NHS Digital service manual](https://beta.nhs.uk/service-manual/).
...
<div class="nhsuk-c-do-dont-list">
  ...
  <ul class="nhsuk-list nhsuk-list--check">
    <li>
    <svg class="nhsuk-icon nhsuk-icon__tick" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
...
<div class="nhsuk-c-do-dont-list">
  ...
  <ul class="nhsuk-list nhsuk-list--cross">
    <li>
    <svg class="nhsuk-icon nhsuk-icon__cross" xmlns="https://www.w3.org/2000/svg" viewBox="0 0 24 24" aria-hidden="true">
