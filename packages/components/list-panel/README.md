...
<div class="nhsuk-c-list-panel nhsuk-c-list-panel--mobile">
  ...
  <ul class="nhsuk-c-list-panel__list  nhsuk-c-list-panel__list--with-label ">
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">AAA</a>
    </li>
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Abdominal aortic aneurysm</a>
    </li>
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Abscess</a>
    </li>
  </ul>
  <div class="nhsuk-c-back-to-top">
    <a class="nhsuk-c-back-to-top__link" href="#nhsuk-nav-a-z">
...
<div class="nhsuk-c-list-panel nhsuk-c-list-panel--mobile">
  ...
  <ul class="nhsuk-c-list-panel__list  nhsuk-c-list-panel__list--with-label ">
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Chest pain</a>
    </li>
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Cold sore</a>
    </li>
  </ul>
  <div class="nhsuk-c-back-to-top">
    <a class="nhsuk-c-back-to-top__link" href="#nhsuk-nav-a-z">
...
<div class="nhsuk-c-list-panel nhsuk-c-list-panel--mobile">
  ...
  <ul class="nhsuk-c-list-panel__list  nhsuk-c-list-panel__list--with-label ">
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Dandruff</a>
    </li>
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Dementia</a>
    </li>
    <li class="nhsuk-c-list-panel__item">
      <a href="/index" class="nhsuk-c-list-panel__link">Dental pain</a>
    </li>
  </ul>
  <div class="nhsuk-c-back-to-top">
    <a class="nhsuk-c-back-to-top__link" href="#nhsuk-nav-a-z">
