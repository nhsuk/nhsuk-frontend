...
- Action link
  ...
  -     </svg>
  +     <svg class="nhsuk-icon nhsuk-icon__arrow-right-circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
...
- Do and don’t lists
  ...
  -       </svg>
  +       <svg class="nhsuk-icon nhsuk-icon__tick" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
  ...
  -       </svg>
  +       <svg class="nhsuk-icon nhsuk-icon__cross" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
...
- Header
  ...
  If you are using navigation, update the menu toggle icon:
  ...
  -   </svg>
  +   <svg class="nhsuk-icon nhsuk-icon__chevron-down" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
  +     <path d="M17 10.9 12.6 15a1 1 0 0 1-1.4 0L7 11a1 1 0 1 1 1.4-1.4L12 13l3.5-3.5a1 1 0 1 1 1.4 1.4Z"></path>
  +   </svg>
    </button>
  ```
  ...
  +   <svg class="nhsuk-icon nhsuk-icon__search" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" role="img" aria-label="Search">
  +     <title>Search</title>
  +     <path d="M19.71 18.29l-4.11-4.1a7 7 0 1 0-1.41 1.41l4.1 4.11a1 1 0 0 0 1.42 0 1 1 0 0 0 0-1.42zM5 10a5 5 0 1 1 5 5 5 5 0 0 1-5-5z"></path>
  +   </svg>
    </button>
  ...
  -   </svg>
  +   <svg class="nhsuk-icon nhsuk-icon__user" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
...
- Pagination
  ...
  -         </svg>
  +         <svg class="nhsuk-icon nhsuk-icon__arrow-left" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
  ...
  -         </svg>
  +         <svg class="nhsuk-icon nhsuk-icon__arrow-right" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
...
- Primary card
  ...
  -       </g>
  -     </svg>
  +    <svg class="nhsuk-icon nhsuk-icon__chevron-right-circle" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="34" height="34" focusable="false" aria-hidden="true">
  +      <path d="M12 2a10 10 0 1 1 0 20 10 10 0 0 1 0-20Zm-1.1 5a1 1 0 1 0-1.4 1.5L13 12l-3.5 3.5a1 1 0 0 0 1.4 1.4l4.2-4.2c.4-.4.4-1 0-1.4Z"></path>
  +    </svg>
      </div>
    </div>
  ```
