...
- Header search - Fix issue with the search dropdown moving down and the dropdown staying visible when you scroll ([Issue 484](https://github.com/nhsuk/nhsuk-frontend/issues/484)) & ([Issue 525](https://github.com/nhsuk/nhsuk-frontend/issues/525)). Also handle the enter keydown event to perform search ([Issue 522](https://github.com/nhsuk/nhsuk-frontend/issues/522))
