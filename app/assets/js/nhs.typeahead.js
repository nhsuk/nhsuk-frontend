      ...
      templates: {
        ...
        suggestion: function(data){
          ...
          switch (data.action_t) {
            case 'Q':
              displayitem = '<li><a href="' + searchUrl + '&query=' + data.action + '">' + displayitem + '</a></li>';
              break;
            case 'E':
              displayitem = '<li><a href="' + searchUrl + '&query=' + data.key + '&' + data.action + '">' + displayitem + '</a></li>';
              break;
            case 'U':
              displayitem = '<li><a href="' + data.action + '">' + displayitem + '</a></li>';
              break;
            case 'C':
              displayitem = '<li><a href="#" onClick="' + data.action + '">'  + displayitem + '</a></li>';
              break;
            default:
              displayitem = '<li><a href="' + searchUrl + '&query=' + data.disp + '">' + displayitem + '</a></li>';
              break;
          }
