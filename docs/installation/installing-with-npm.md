...
To use HSE frontend in your projects with npm you must:
...
Install the HSE frontend package into your project:
...
You will need to import a couple of things into your project before you can start using HSE frontend:
...
You need to import the HSE frontend styles into the main Sass file in your project. You should place the below code before your own Sass rules (or Sass imports).
...
You should include HSE frontend JavaScript in your project to ensure that all users can use it successfully.
