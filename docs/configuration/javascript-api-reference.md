...
### chooseFilesButtonClasses

Type: array

Modifier class names added to the choose files button.
...
Class name added to the linked element focused by the skip link. Used to remove the visible focus indicator because the user cannot interact with it.
